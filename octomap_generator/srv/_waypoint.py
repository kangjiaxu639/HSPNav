...
"""autogenerated by genpy from octomap_generator/waypointRequest.msg. Do not edit."""
import codecs
import sys
...
class waypointRequest(genpy.Message):
  _md5sum = "fe80b4da70b94cce4cab049885c92b1f"
  _type = "octomap_generator/waypointRequest"
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from octomap_generator/waypointResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class waypointResponse(genpy.Message):
  ...
  _type = "octomap_generator/waypointResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# 服务器发送的waypoint坐标
float64 x
float64 y
...
class waypoint(object):
  _type          = 'octomap_generator/waypoint'
  _md5sum = 'ae9db04b97b0a74e4196b77a058e79f5'
